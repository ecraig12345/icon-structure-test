...
const rawSvgAccessibilityCheckmark24Filled = (iconProps: IFluentIconsProps) => {
...
export const AccessibilityCheckmark24Filled = /*#__PURE__*/ wrapIcon(/*#__PURE__*/ rawSvgAccessibilityCheckmark24Filled({}), 'AccessibilityCheckmark24Filled');

const rawSvgAccessibilityCheckmark24Regular = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const AccessibilityCheckmark24Regular = /*#__PURE__*/ wrapIcon(/*#__PURE__*/ rawSvgAccessibilityCheckmark24Regular({}), 'AccessibilityCheckmark24Regular');
