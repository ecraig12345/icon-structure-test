...
export const AccessibilityCheckmark24Filled = wrapIcon(rawSvgAccessibilityCheckmark24Filled({}), 'AccessibilityCheckmark24Filled');
...
export const AccessibilityCheckmark24Regular = wrapIcon(rawSvgAccessibilityCheckmark24Regular({}), 'AccessibilityCheckmark24Regular');
