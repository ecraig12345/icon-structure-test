...
const rawSvgAdd12Filled = (iconProps: IFluentIconsProps) => {
...
export const Add12Filled = wrapIcon(rawSvgAdd12Filled({}), 'Add12Filled');

const rawSvgAdd12Regular = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add12Regular = wrapIcon(rawSvgAdd12Regular({}), 'Add12Regular');

const rawSvgAdd16Filled = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add16Filled = wrapIcon(rawSvgAdd16Filled({}), 'Add16Filled');

const rawSvgAdd16Regular = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add16Regular = wrapIcon(rawSvgAdd16Regular({}), 'Add16Regular');

const rawSvgAdd20Filled = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add20Filled = wrapIcon(rawSvgAdd20Filled({}), 'Add20Filled');

const rawSvgAdd20Regular = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add20Regular = wrapIcon(rawSvgAdd20Regular({}), 'Add20Regular');

const rawSvgAdd24Filled = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add24Filled = wrapIcon(rawSvgAdd24Filled({}), 'Add24Filled');

const rawSvgAdd24Regular = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add24Regular = wrapIcon(rawSvgAdd24Regular({}), 'Add24Regular');

const rawSvgAdd28Filled = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add28Filled = wrapIcon(rawSvgAdd28Filled({}), 'Add28Filled');

const rawSvgAdd28Regular = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const Add28Regular = wrapIcon(rawSvgAdd28Regular({}), 'Add28Regular');
