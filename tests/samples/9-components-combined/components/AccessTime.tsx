...
const rawSvgAccessTime24Filled = (iconProps: IFluentIconsProps) => {
...
export const AccessTime24Filled = /*#__PURE__*/ wrapIcon(/*#__PURE__*/ rawSvgAccessTime24Filled({}), 'AccessTime24Filled');

const rawSvgAccessTime24Regular = (iconProps: IFluentIconsProps) => {
  const { className, primaryFill } = iconProps;
...
export const AccessTime24Regular = /*#__PURE__*/ wrapIcon(/*#__PURE__*/ rawSvgAccessTime24Regular({}), 'AccessTime24Regular');
