...
export const AccessTime24Filled = wrapIcon(rawSvgAccessTime24Filled({}), 'AccessTime24Filled');
...
export const AccessTime24Regular = wrapIcon(rawSvgAccessTime24Regular({}), 'AccessTime24Regular');
